...
```
To get a clearer overall image of what Alan is describing, we will compare and contrast the example of the biological cell with 
the modern understanding of OOP in three main areas: Messaging, Concurrency and Data-Hiding. Then we will take a brief look
into what the Actor Model is and it's similarity to Alan Kay's conception of OOP.
